"""
This script is a modified version of the baseRobotiq3FGripper.py script from the robotiq_3f_gripper_control package.
"""

from GripperIO import Robotiq3FGripperRobotInput
